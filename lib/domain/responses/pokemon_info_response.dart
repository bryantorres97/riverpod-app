...
//
//     final pokemonInfoResponse = pokemonInfoResponseFromJson(jsonString);

import 'dart:convert';

PokemonInfoResponse pokemonInfoResponseFromJson(String str) =>
    PokemonInfoResponse.fromJson(json.decode(str));

String pokemonInfoResponseToJson(PokemonInfoResponse data) =>
